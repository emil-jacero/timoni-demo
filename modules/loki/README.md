...
A [timoni.sh](http://timoni.sh) module for deploying grafana to Kubernetes clusters.
...
```shell
timoni -n default apply grafana oci://<container-registry-url>
```
...
```shell
timoni -n default delete grafana
```
